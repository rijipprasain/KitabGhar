              ...
              <form class="form-horizontal" method="POST" action="products_edit.php">
                <input type="hidden" class="prodid" name="id">
                  <div class="form-group">
                      <label for="edit_isbn" class="col-sm-1 control-label">ISBN</label>
                  ...
                  <div class="form-group">
                      ...
                      <label for="edit_publication_year" class="col-sm-1 control-label">Publication Year</label>

                      <div class="col-sm-5">
                          <input type="date" class="form-control" id="edit_publication_year" name="publication_year" required>
                      </div>
                  </div>
                  <div class="form-group">
                      <label for="edit_publisher" class="col-sm-1 control-label">Publisher</label>

                      <div class="col-sm-5">
                          <input type="text" class="form-control" id="edit_publisher" name="publisher" required>
                      </div>

                      <label for="edit_author" class="col-sm-1 control-label">Author</label>
                  ...
                  <div class="form-group">
                      <div class="col-sm-12">
                          <textarea id="editor2" name="overview" rows="10" cols="80" required></textarea>
                      </div>
